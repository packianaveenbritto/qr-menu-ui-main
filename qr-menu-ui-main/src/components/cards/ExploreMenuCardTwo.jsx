...
const ExploreMenuCardTwo = ({
	...
	return (
		<>
			<Card className='p-2 border-0 custom-card'>
				<div className='d-flex'>
					<div className='col-9 d-flex flex-column'>
						...
						<div className={`footer-text d-flex align-items-end mt-auto`}>
							<div className='d-flex'>
								<div
									style={{
										fontSize: '11px',
					...
					<div className='col-3 d-flex flex-column align-items-center'>
						<div className='appetizers-card-img-continer-two d-flex p-1'>
						<img className='main-img' src={img} alt='' />
						<img width={14} className='hart-img' src={icon} alt='' />
						</div>
						{selected ? (
							<button className='card-footer-button mt-1'>
							...
							<button
								onClick={onClickAdd}
								key={index}
								className='card-footer-button-fill mt-1'
								style={{ fontSize: '10px' }}>
								ADD TO CART
							</button>
						)}
...
export default ExploreMenuCardTwo;
